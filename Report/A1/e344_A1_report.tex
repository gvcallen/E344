...
\newcommand{\nameInitial}{
    \textcolor{red}{E. Stewdent}  %change colour to black and enter your initial and surname
}
\newcommand{\nameFull}{
    \textcolor{red}{Egor Stewdent} %change colour to black and enter your firstname and surname
}
\newcommand{\stNumber}{
    \textcolor{red}{00024601} %change to black and enter your student number 
}
\newcommand{\myDate}{\textcolor{red}{\today} %change colour and if you want to date.
}
