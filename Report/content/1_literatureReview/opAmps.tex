...
\subsection{Limitations}\label{sec:opamps_limits}
...
\subsection{Considerations}\label{sec:opamps_considerations}
...
\subsection{MCP6242}\label{sec:opamps_MCP6242}
...
\subsection{Configurations}\label{sec:opamps_configs}
