...
\begin{figure}[!h]
   ...
   \begin{minipage}{0.45\textwidth}
      \centering
      \includegraphics[width=0.7\linewidth]{Figures/results_currentSensor_noise}
      \captionof{figure}{Amplifier noise rejection}
      \label{fig:results_currentSensor_noise}
   \end{minipage}
   \begin{minipage}{0.45\textwidth}
      \centering
      \includegraphics[width=0.7\linewidth]{Figures/results_currentSensor_riseTime}
...
\begin{figure}[!h]
   ...
   \begin{minipage}{0.3\textwidth}
      \centering
      \includegraphics[width=0.7\linewidth]{Figures/results_free}
      \captionof{figure}{0 A to free running}
   \end{minipage}
   \begin{minipage}{0.3\textwidth}
      \centering
      \includegraphics[width=0.7\linewidth]{Figures/results_increasingLoad}
      \captionof{figure}{Increasing load}
   \end{minipage}
   \begin{minipage}{0.3\textwidth}
      \centering
      \includegraphics[width=0.7\linewidth]{Figures/results_stall}
